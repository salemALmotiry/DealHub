...
// Accepts or rejects the base offer by the owner for a specific rental
    ...
    public DetailRentalOfferDTO respondToRentalOfferByOwner(Integer rentalOfferId, Double ownerProposedRent) {
        RentalOffer rentalOffer = rentalOfferRepository.findRentalOfferById(rentalOfferId);
    ...
    public DetailRentalOfferDTO updateRentalOfferByIndividual(Integer rentalOfferId, Double individualProposedRent) {
        RentalOffer rentalOffer = rentalOfferRepository.findRentalOfferById(rentalOfferId);
        if(rentalOffer == null){
    ...
    public DetailRentalOfferDTO userAcceptOrRejectOwnerResponse(Integer rentalOfferId, Boolean Accepted) {
        RentalOffer rentalOffer = rentalOfferRepository.findRentalOfferById(rentalOfferId);
    ...
    // Accepts or rejects the individual's offer by the owner
    public DetailRentalOfferDTO ownerAcceptOrRejectIndividualOffer(Integer rentalOfferId, Boolean accepted) {
        RentalOffer rentalOffer = rentalOfferRepository.findRentalOfferById(rentalOfferId);
        Rental rental = rentalOffer.getRental();
        if(!"Pending by owner".equals(rentalOffer.getStatus())){
