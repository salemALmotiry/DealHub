...
public class RentalPropertyService {
    ...
    public RentalDTO convertRentalDto(Rental rental){
        ...
        return new RentalDTO(null,owner.getFullName(),rental.getName(),rental.getAnnulRent(),rental.getAvaiilableStatus(),rental.getCity(),rental.getLocation(), rental.getRentalType(), rental.getUnitType(),rental.getFloor(),rental.getUnitAge(),rental.getUnitNumber(),rental.getUnitArea());
    }
